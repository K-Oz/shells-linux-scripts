# ubuntu-focal-kubuntu-desktop Configuration Template

## Image Details
- **Distribution:** ubuntu
- **Version:** focal
- **Variant:** kubuntu-desktop
- **Type:** desktop
- **Full Name:** ubuntu-focal-kubuntu-desktop

## Build Command
```bash
./build_image.sh ubuntu-focal-kubuntu-desktop
```

## Description
This configuration builds a ubuntu focal system with kubuntu-desktop.
...
```bash
./test-linux.sh ubuntu-focal-kubuntu-desktop-$(date +%Y%m%d).qcow2
```

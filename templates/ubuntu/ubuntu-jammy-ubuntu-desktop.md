# ubuntu-jammy-ubuntu-desktop Configuration Template
...
- **Type:** desktop
- **Full Name:** ubuntu-jammy-ubuntu-desktop

## Build Command
```bash
./build_image.sh ubuntu-jammy-ubuntu-desktop
```

## Description
This configuration builds a ubuntu jammy system with ubuntu-desktop.
...
```bash
./test-linux.sh ubuntu-jammy-ubuntu-desktop-$(date +%Y%m%d).qcow2
```

# ubuntu-noble-ubuntu-desktop Configuration Template
...
- **Type:** desktop
- **Full Name:** ubuntu-noble-ubuntu-desktop

## Build Command
```bash
./build_image.sh ubuntu-noble-ubuntu-desktop
```

## Description
This configuration builds a ubuntu noble system with ubuntu-desktop.
...
```bash
./test-linux.sh ubuntu-noble-ubuntu-desktop-$(date +%Y%m%d).qcow2
```

# ubuntu-focal-kde-neon-desktop Configuration Template

## Image Details
- **Distribution:** ubuntu
- **Version:** focal
- **Variant:** kde-neon-desktop
- **Type:** desktop
- **Full Name:** ubuntu-focal-kde-neon-desktop

## Build Command
```bash
./build_image.sh ubuntu-focal-kde-neon-desktop
```

## Description
This configuration builds a ubuntu focal system with kde-neon-desktop.
...
```bash
./test-linux.sh ubuntu-focal-kde-neon-desktop-$(date +%Y%m%d).qcow2
```
